...
void PrimMeshModel::LoadPrimitive(Primitive primitive, int n)
{
    ...
    switch (primitive) {
        case Primitive::Cube: {
            ...
            FixCCWOriented(*this);
            LOG_DEBUG("MeshModel is well oriented: {}", TestIfCCWOriented(*this));
            break;
        } // cube
        ...
        case Primitive::Sphere: {
            ...
            std::function<void(const Vec3 &, const Vec3 &, const Vec3 &,
                               const int)> divide_triangle = [&divide_triangle, &triangle](const Vec3 &a, const Vec3 &b,
                                                                                           const Vec3 &c, const int n) {
                if (n > 0) {
